...
- <a href="./install/getting-started-knative-app#sample-application">Deploying a container (./ no .md)</a>
...
- <a href="./serving/samples/blue-green-deployment">Routing and managing traffic with blue/green deployment</a>
